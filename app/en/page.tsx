  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        <Image src="/images/hero.webp" alt="A modern premium school campus connected by an institutional digital platform" fill priority sizes="100vw" />
